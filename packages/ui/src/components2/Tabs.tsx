  ...
  variants: {
    ...
    variant: {
      line: {
        ...
        tab: [
          "text-fg-muted selected:text-foreground disabled:selected:bg-[initial]",
...
const TabList = <T extends object>({
  ...
  ComponentPropsWithRef<typeof AriaTabList>) => {
...
const Tab = (props: TabProps & ComponentPropsWithRef<typeof AriaTab>) => {
