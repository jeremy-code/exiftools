  ...
  wrapUpdate(fn) {
    if ("startViewTransition" in document) {
      document.startViewTransition(() => {
        // eslint-disable-next-line @eslint-react/dom/no-flush-sync, @typescript-eslint/no-unsafe-call -- Per https://developer.chrome.com/docs/web-platform/view-transitions/same-document#working_with_frameworks and Dan Abramov, this is correct for view transitions
        flushSync(fn);
      });
    } else {
      fn();
